...
<head>
      ...
      <title>Selly Bumdes - by Siti Fitrianah</title>
        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="<?=base_url('dashboard')?>" class="logo">
                    <span class="logo-mini">S<b>B</b></span>
                    <span class="logo-lg">Selly<b>Bumdes</b></span>
        </a>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      ...
                      <div class="pull-right">
                        <a href="<?=site_url('auth/logout')?>" class="btn btn-flat bg-reg">Sign out</a>
                      </div>
                    </li>
                </ul>
              </li>
        ...
        <section class="sidebar">
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <a href="<?=site_url('user')?>"><i class="fa fa-circle text-success"></i> Online</a>
            </div>
          </div>
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <li <?=$this->uri->segment(1) == 'customer'  ? 'class="active"' : ''?>>
                <a href="<?=site_url('customer')?>"><i class="fa fa-truck"></i><span>Customers</span></a>
              </a>
            ...
            <a href="#">
                <i class="fa fa-shopping-chart"></i> <span>Transaction</span>
                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
            </a>
            <ul class="treeview-menu">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="https://FitriCoding.id">FitriCoding</a>.</strong> All right reserved.
    </footer>
